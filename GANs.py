...
dataloader = create_dataloaders(transforms_train, transforms_test, batch_size, 'CIFAR10', add_idx=True, reduce_dataset=True)
...
for epoch in range(num_epochs):
    ...
    for i, (img_tensor, label_tensor, id) in enumerate(dataloader['train']):
        ############################
